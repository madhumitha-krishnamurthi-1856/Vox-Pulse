...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-DV1i7dbk.mjs");
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-CDYxipfc.mjs"),
		import("./start-GaSxouQG.mjs"),
		import("./empty-plugin-adapters-DIRsN0MT.mjs")
	]);
	return {
		routerEntry,
		startEntry,
