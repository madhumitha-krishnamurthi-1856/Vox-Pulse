...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Aggregate customer feedback for any brand from Reddit, G2, Capterra, Trustpilot, Bluesky and Hacker News in seconds." },
      ...
      <main className="mx-auto max-w-3xl px-6 pb-24 pt-16 sm:pt-24">
        <div className="mb-10 text-center">
          ...
          <p className="mx-auto mt-5 max-w-xl text-muted-foreground">
            Aggregate feedback from Reddit, G2, Capterra, Trustpilot, Bluesky and Hacker News.
